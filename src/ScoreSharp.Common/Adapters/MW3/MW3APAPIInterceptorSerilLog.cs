...
public class MW3APAPIInterceptorSerilLog : DelegatingHandler
{
    private readonly ILogger<MW3APAPIInterceptorSerilLog> _logger;

    public MW3APAPIInterceptorSerilLog(ILogger<MW3APAPIInterceptorSerilLog> logger)
        : base(
    ...
    public MW3APAPIInterceptorSerilLog(HttpMessageHandler handler, ILogger<MW3APAPIInterceptorSerilLog> logger)
        : base(handler)
    {
        this._logger = logger;
    }
