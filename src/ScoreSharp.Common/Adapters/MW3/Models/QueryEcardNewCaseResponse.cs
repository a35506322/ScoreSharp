...
public class QueryEcardNewCaseResponse
{
    ...
    public QueryEcardNewCaseResponseInfo Info { get; set; } = null!;
}

public class QueryEcardNewCaseResponseInfo
{
    [JsonPropertyName("data")]
    public string Data { get; set; } = null!;
}

public class EcardNewCaseData
{
    ...
    [JsonPropertyName("info")]
    public EcardNewCaseRequest? Info { get; set; }
}
