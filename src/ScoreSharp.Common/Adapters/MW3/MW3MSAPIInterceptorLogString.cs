...
public class MW3MSAPIInterceptorLogString : DelegatingHandler
{
    private readonly ILogger<MW3MSAPIInterceptorLogString> _logger;

    public MW3MSAPIInterceptorLogString(ILogger<MW3MSAPIInterceptorLogString> logger)
        : base(
    ...
    public MW3MSAPIInterceptorLogString(HttpMessageHandler handler, ILogger<MW3MSAPIInterceptorLogString> logger)
        : base(handler)
    {
        this._logger = logger;
    }
