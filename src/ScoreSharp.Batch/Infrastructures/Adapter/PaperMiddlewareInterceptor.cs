...
public class PaperMiddlewareInterceptor : DelegatingHandler
{
    private readonly ILogger<PaperMiddlewareInterceptor> _logger;

    public PaperMiddlewareInterceptor(ILogger<PaperMiddlewareInterceptor> logger)
        : base(
