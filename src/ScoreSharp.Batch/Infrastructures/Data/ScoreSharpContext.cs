...
using ScoreSharp.Batch.Infrastructures.Data.Entities;
...
public partial class ScoreSharpContext : DbContext
{
    ...
    public virtual DbSet<ReviewerLog_GuoLuKaCheckFail> ReviewerLog_GuoLuKaCheckFail { get; set; }
    ...
    public virtual DbSet<System_TmpRecord> System_TmpRecord { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<OrgSetUp_User>(entity =>
        {
            ...
            entity.Property(e => e.Mima)
                ...
                .IsUnicode(false)
                .HasComment("密碼");
            entity.Property(e => e.MimaErrorCount).HasComment("密碼錯誤次數\r\n1. 預設 0\r\n2. 達 5 次 IsActive = N，StopReason　= 密碼輸入超過5次");
        ...
        modelBuilder.Entity<ReviewerLog_GuoLuKaCheckFail>(entity =>
        {
            entity.HasKey(e => e.SeqNo);

            entity.HasIndex(e => e.ApplyNo, "IX_ReviewerLog_GuoLuKaCheckFail");
            ...
            entity.Property(e => e.ID)
                ...
                .IsUnicode(false)
                .HasComment("身分證字號");
            entity.Property(e => e.Response).HasComment("回覆");
            entity.Property(e => e.SendFailLog).HasComment("錯誤訊息");
        ...
        modelBuilder.Entity<System_TmpRecord>(entity =>
        {
            entity.HasKey(e => e.SeqNo);

            entity.Property(e => e.SeqNo).HasComment("PK");
            entity.Property(e => e.SystemAssignment_ManualCaseLastUserId)
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasComment("系統派案_人工徵信件最後派案人員");
            entity.Property(e => e.SystemAssignment_PaperCaseLastUserId)
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasComment("系統派案_紙本件預審最後派案人員");
            entity.Property(e => e.SystemAssignment_WebCaseLastUserId)
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasComment("系統派案_網路件預審最後派案人員");
        });
