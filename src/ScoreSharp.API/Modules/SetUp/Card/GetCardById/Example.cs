...
public class 取得信用卡卡片種類_2000_ResEx : IExampleProvider<ResultResponse<GetCardByIdResponse>>
{
    public ResultResponse<GetCardByIdResponse> GetExample()
    {
        GetCardByIdResponse response = new()
        {
            BINCode = "35665779",
            CardCode = "JST79",
            CardName = "國民旅遊悠遊晶緻卡",
...
[ExampleAnnotation(Name = "[4001]取得信用卡卡片種類-查無此資料", ExampleType = ExampleType.Response)]
public class 取得信用卡卡片種類查無此資料_4001_ResEx : IExampleProvider<ResultResponse<string>>
{
    public ResultResponse<string> GetExample()
    {
        return ApiResponseHelper.NotFound<string>(null, "35665743");
    }
}
