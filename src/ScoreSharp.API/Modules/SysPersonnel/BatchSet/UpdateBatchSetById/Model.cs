...
public class UpdateBatchSetByIdRequest
{
    /// <summary>
    /// PK
    /// </summary>
    ...
    public string RetryWebCaseFileErrorJob_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string A02KYCSyncJob_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string CompareMissingCases_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string EcardA02CheckNewCase_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string EcardNotA02CheckNewCase_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string GuoLuKaCheck_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string PaperCheckNewCase_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string RetryKYCSync_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string SendKYCErrorLog_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string SendSystemErrorLog_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string SupplementTemplateReport_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string SystemAssignment_WebCase_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string SystemAssignment_Paper_IsEnabled { get; set; }
    ...
    [Required]
    [RegularExpression("^[YN]$")]
    public string SystemAssignment_ReviewManual_IsEnabled { get; set; }
}
