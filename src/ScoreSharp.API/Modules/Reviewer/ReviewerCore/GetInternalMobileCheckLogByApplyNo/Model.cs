...
public class GetInternalMobileCheckLogByApplyNoResponse
{
    /// <summary>
    /// 申請書編號
    /// </summary>
    ...
    ///
    /// </summary>
    public string SameInternalMobileChecked { get; set; } = null!;

    /// <summary>
    /// 確認紀錄
    ///
    /// 1.於月收入確認簽核時，當 SameInternalMobileChecked =Y，需填寫原因
    /// </summary>
    ...
    /// 相同行內手機號碼記錄
    /// </summary>
    public List<SameInternalMobileCheckDetailDto> SameInternalMobileCheckDetails { get; set; } = new();
}

public class SameInternalMobileCheckDetailDto
{
    /// <summary>
    /// 現行申請書編號，FK
    /// </summary>
...
public class InternalMobileDto
{
