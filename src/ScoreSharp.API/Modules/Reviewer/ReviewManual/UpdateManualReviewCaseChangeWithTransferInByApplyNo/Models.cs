...
public class UpdateManualReviewCaseChangeWithTransferInByApplyNoRequest : IValidatableObject
{
    /// <summary>
    /// PK
    /// </summary>
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        // 核卡作業中必填欄位　=> 建議額度、徵信代碼
        if (CaseChangeAction == ManualReviewAction.核卡作業)
        {
        ...
        // 退件作業中必填欄位　=> 退件原因代碼 、 (是否列印簡訊、紙本通知函) 、 退件寄送地址
        if (CaseChangeAction == ManualReviewAction.退件作業)
        {
        ...
        // 補件作業中必填欄位　=> 補件原因代碼 、 (是否列印簡訊、紙本通知函) 、 補件寄送地址
        if (CaseChangeAction == ManualReviewAction.補件作業)
        {
        ...
        // 撤件作業中必填欄位　=> 撤件註記
        if (CaseChangeAction == ManualReviewAction.撤件作業)
        {
