namespace ScoreSharp.InfoCheckMiddleware.Common.Helpers;
...
public static class ApiResponseHelper
{
    ...
    public static ResultResponse InternalServerError(string message, string errorDetail = "") =>
        new ResultResponse(
    ...
    /// <returns></returns>
    public static ResultResponse BadRequest(Dictionary<string, string[]> errors) =>
        new ResultResponse(
    ...
    /// <param name="errors"></param>
    /// <returns></returns>
    public static ResultResponse DatabaseDefinitionValueError(Dictionary<string, string[]> errors) =>
        new ResultResponse(
    ...
    /// <returns></returns>
    public static ResultResponse NotFound(string message) =>
        new ResultResponse(
    ...
    public static ResultResponse ExternalServiceError(string message) =>
        new ResultResponse(
    ...
    public static ResultResponse BusinessBadRequestError(string message) =>
        new ResultResponse(
    ...
    public static ResultResponse DatabaseExecuteError(string message, string errorDetail = "") =>
        new ResultResponse(
    ...
    public static ResultResponse HeaderValidationError(string message) =>
        new ResultResponse(
